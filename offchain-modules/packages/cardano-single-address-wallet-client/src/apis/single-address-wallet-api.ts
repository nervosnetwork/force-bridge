...
export const SingleAddressWalletsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        deleteWallet: async (walletId: string, options: any = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/single-address-wallets/{walletId}`
        ...
        listTransactions: async (walletId: string, start?: string, end?: string, order?: string, minWithdrawal?: number, options: any = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/single-address-wallets/{walletId}/transactions`
                .replace(`{${"walletId"}}`, encodeURIComponent(String(walletId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
        ...
        coinSelection: async (body: ApiPostTransactionFeeData, walletId: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
            ...
            const localVarPath = `/single-address-wallets/{walletId}/coin-selections/random`
                .replace(`{${"walletId"}}`, encodeURIComponent(String(walletId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
...
export const SingleAddressWalletsApiFp = function(configuration?: Configuration) {
    return {
        ...
        async deleteWallet(walletId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await SingleAddressWalletsApiAxiosParamCreator(configuration).deleteWallet(walletId, options);
         ...
         * @throws {RequiredError}
         */
        async getWallet(walletId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiSingleAddressWallet>> {
            const localVarAxiosArgs = await SingleAddressWalletsApiAxiosParamCreator(configuration).getWallet(walletId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async listWallets(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ApiSingleAddressWallet>>> {
         ...
         * @throws {RequiredError}
         */
        async postWallet(body: ApiSingleAddressWalletPostData, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiSingleAddressWallet>> {
      ...
      async listTransactions(walletId: string, start?: string, end?: string, order?: string, minWithdrawal?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ApiTransaction>>> {
        const localVarAxiosArgs = await SingleAddressWalletsApiAxiosParamCreator(configuration).listTransactions(walletId, start, end, order, minWithdrawal, options);
        return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
          const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
          return axios.request(axiosRequestArgs);
        };
      ...
      async coinSelection(body: ApiPostTransactionFeeData, walletId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiCoinSelection>> {
        const localVarAxiosArgs = await SingleAddressWalletsApiAxiosParamCreator(configuration).coinSelection(body, walletId, options);
        return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
          const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
          return axios.request(axiosRequestArgs);
        };
 ...
 * @export
 */
export const SingleAddressWalletsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * <p align=\"right\">status: <strong>stable</strong></p> 
         * @summary Delete
        ...
        deleteWallet(walletId: string, options?: any): AxiosPromise<void> {
            return SingleAddressWalletsApiFp(configuration).deleteWallet(walletId, options).then((request) => request(axios, basePath));
        },
        /**
         * <p align=\"right\">status: <strong>stable</strong></p> 
         * @summary Get
        ...
        getWallet(walletId: string, options?: any): AxiosPromise<ApiSingleAddressWallet> {
            return SingleAddressWalletsApiFp(configuration).getWallet(walletId, options).then((request) => request(axios, basePath));
        },
        /**
         * <p align=\"right\">status: <strong>stable</strong></p>  Return a list of known wallets, ordered from oldest to newest. 
         * @summary List
        ...
        listWallets(options?: any): AxiosPromise<Array<ApiSingleAddressWallet>> {
            return SingleAddressWalletsApiFp(configuration).listWallets(options).then((request) => request(axios, basePath));
        },
        /**
         * <p align=\"right\">status: <strong>stable</strong></p>  Create and restore a wallet from a mnemonic sentence or account public key. 
         * @summary Create / Restore
        ...
        postWallet(body: ApiSingleAddressWalletPostData, options?: any): AxiosPromise<ApiSingleAddressWallet> {
            return SingleAddressWalletsApiFp(configuration).postWallet(body, options).then((request) => request(axios, basePath));
        },

        listTransactions(walletId: string, options?: any): AxiosPromise<Array<ApiTransaction>> {
          return SingleAddressWalletsApiFp(configuration).listTransactions(walletId, options).then((request) => request(axios, basePath));
        },

        coinSelection(body: ApiPostTransactionFeeData, options?: any): AxiosPromise<ApiCoinSelection> {
          return SingleAddressWalletsApiFp(configuration).coinSelection(body, options).then((request) => request(axios, basePath));
        },
    };
};
