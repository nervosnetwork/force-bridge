...
${FORCE_BRIDGE_CLI} eos balanceOf -addr ${CKB_RECIPIENT_ADDRESS}
${FORCE_BRIDGE_CLI} eos lock -p ${EOS_LOCKED_PRIVATE_KEY} -acc ${EOS_LOCKED_ACCOUNT} -r ${CKB_RECIPIENT_ADDRESS} -a 0.0001
sleep 60
${FORCE_BRIDGE_CLI} eos balanceOf -addr ${CKB_RECIPIENT_ADDRESS}
${FORCE_BRIDGE_CLI} eos unlock -p ${CKB_PRIVATE_KEY} -a 0.0001 -r ${EOS_LOCKED_ACCOUNT}
sleep 60
${FORCE_BRIDGE_CLI} eos balanceOf -addr ${CKB_RECIPIENT_ADDRESS}
