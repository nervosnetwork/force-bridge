...
const pageName = "getBridgeNervosToXchainLockBridgeFee.html";
beforeEach(async () => {
  await goto.goto(page, pageName);
});

describe("getBridgeNervosToXchainLockBridgeFee", () => {
  it("getBridgeNervosToXchainLockBridgeFee_1", async () => {
    const res = {
      jsonrpc: "2.0",
      id: 145,
      result: {
  ...
  * more params
  */
  it("getBridgeNervosToXchainLockBridgeFee_2", async () => {
  ...
  * none params
  */
  it("getBridgeNervosToXchainLockBridgeFee_3", async () => {
    const testType = await page.$(goto.pageIds.testTypeId);
